...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: black;"><b>Sistem Informasi </b><br/><b>Perpustakaan</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:4px solid #226bbf;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-2">
          <button type="submit" id="loding" class="btn btn-primary btn-block ">Masuk</button>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: black;"> Copyright &copy; SIPUS- <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
